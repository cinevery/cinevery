  ...
  public LocalDate deserialize(JsonParser parser, DeserializationContext context) throws IOException {
    switch (parser.getCurrentToken()) {
      case START_ARRAY:
        ...
        if (parser.nextToken() != JsonToken.END_ARRAY) {
          throw context.wrongTokenException(parser, JsonToken.END_ARRAY, MessageConstants.END_ARRAY_MESSAGE);
        }
    ...
    throw context.wrongTokenException(parser, JsonToken.START_ARRAY, MessageConstants.START_ARRAY_MESSAGE);
  }
}
